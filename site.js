...
let quoteCatalog = {
  ...
  services: [
    ...
    { id: "kitchen_recaulk", category: "General", subcategory: "Caulking", name: "Kitchen Re-Caulk", unit: "job", low: 250, high: 500, min: 250, included: 1, assumptions: "Standard kitchen sink, counter, backsplash, or appliance-edge caulk. Water damage, tile repair, and grout are separate." },
    ...
    { id: "fence_repair_lf", category: "Decks & Fences", subcategory: "Fences & Gates", name: "Fence Repair / Section Rebuild", unit: "lf", low: 0, high: 0, unitLow: 30, unitHigh: 70, min: 650, included: 20, photos: true, siteVisit: true, assumptions: "Linear-foot fence repair for a known damaged run. Assumes existing posts are mostly serviceable and the work is localized to boards/rails/resetting. Add fence post replacement separately for failed posts. Demo haul-away, slope, staining/paint, or a full new fence install can change the range." },
    { id: "fence_post_replace", category: "Decks & Fences", subcategory: "Fences & Gates", name: "Fence Post Replacement", unit: "item", low: 350, high: 650, unitLow: 350, unitHigh: 650, min: 350, included: 1, photos: true, assumptions: "Per post. Includes typical dig-out/reset or replacement labor range. Concrete removal, slope, roots, poor access, and rail/board tie-back can move the range." },
